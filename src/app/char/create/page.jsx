...
export default function Create() {
    ...
    const questions = [
        {
            text: "Qual o nome do seu personagem?",
            validate: (input) => input.trim().length > 0 || "O nome não pode ser vazio."
        },
        {
            text: "Qual a raça do seu personagem?",
        ...
        {
            text: "Qual a classe do seu personagem?",
        ...
        {
            text: "Qual o valor de Força do seu personagem?",
            validate: (input) =>
        ...
        {
            text: "Qual o valor de Destreza do seu personagem?",
            validate: (input) =>
                /^\d+$/.test(input) && Number(input) >= 3 && Number(input) <= 18
                    ? true
                    : "O valor deve ser um número entre 3 e 18."
        ...
        {
            text: "Qual o valor de Constituição do seu personagem?",
            validate: (input) =>
                /^\d+$/.test(input) && Number(input) >= 3 && Number(input) <= 18
                    ? true
                    : "O valor deve ser um número entre 3 e 18."
        ...
        {
            text: "Qual o valor de Inteligência do seu personagem?",
            validate: (input) =>
                /^\d+$/.test(input) && Number(input) >= 3 && Number(input) <= 18
                    ? true
                    : "O valor deve ser um número entre 3 e 18."
        ...
        {
            text: "Qual o valor de Sabedoria do seu personagem?",
            validate: (input) =>
                /^\d+$/.test(input) && Number(input) >= 3 && Number(input) <= 18
                    ? true
                    : "O valor deve ser um número entre 3 e 18."
        ...
        {
            text: "Qual o valor de Carisma do seu personagem?",
            validate: (input) =>
                /^\d+$/.test(input) && Number(input) >= 3 && Number(input) <= 18
                    ? true
                    : "O valor deve ser um número entre 3 e 18."
    ...
    const sendMessage = () => {
        ...
        if (currentQuestionIndex + 1 < questions.length) {
            ...
            setMessages((prevMessages) => [
                ...prevMessages,
                { type: "bot", text: "Todas as informações foram coletadas!" }
            ]);
        }
                    ...
                    <div className="messages">
                        {messages.map((message, index) => (
                            ...
                            >
                                ...
                                {message.type === "user" && <p>{message.user}</p>}
                            </div>
                        ))}
                        {currentQuestion && <div className="message bot">{currentQuestion.text}</div>}
                    </div>
